...
```
cd existing_repo
git remote add origin https://gitlab.com/caentoche/backend/back-symfony.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/caentoche/backend/back-symfony/-/settings/integrations)
